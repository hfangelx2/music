...
// AudioStreamer
#define COCOAPODS_POD_AVAILABLE_AudioStreamer
#define COCOAPODS_VERSION_MAJOR_AudioStreamer 0
#define COCOAPODS_VERSION_MINOR_AudioStreamer 1
#define COCOAPODS_VERSION_PATCH_AudioStreamer 0
