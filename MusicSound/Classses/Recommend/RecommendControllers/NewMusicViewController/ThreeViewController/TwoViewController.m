...
- (void)viewDidLoad {
    ...
    NSLog(@"%@", self.msg_id);
    [self getData];
    self.myTableView = [[UITableView alloc] initWithFrame:CGRectMake(0, 0, self.view.frame.size.width, self.view.frame.size.height - 64 - 44) style:UITableViewStylePlain];
    ...
    self.musicHV = [[twoHeaderView alloc] initWithFrame:CGRectMake(0, 0, self.view.frame.size.width, 200 * adapter.sHeight)];
