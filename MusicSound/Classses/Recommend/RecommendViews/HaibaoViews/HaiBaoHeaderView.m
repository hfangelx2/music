...
@implementation HaiBaoHeaderView
...
-(void)createSubviews
{
    ...
    self.textRight = [[UILabel alloc] initWithFrame:CGRectMake(self.frame.size.width * 2 + 20, 0, self.frame.size.width - 40, self.frame.size.height)];
    self.textRight.backgroundColor = [UIColor clearColor];
...
- (void)setArray:(NSMutableArray *)array
{
    ...
    self.headerBlock(self.myHaiModel.songlistname);
