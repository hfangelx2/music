...
#pragma mark -
#pragma mark --初始化方法--
- (id)initWithFrame:(CGRect)frame andNodeCount:(NSMutableArray *)nodeCount
{
    self = [super initWithFrame:frame];
    if (self) {
        
        CGSize nodeSize = CGSizeMake(100, 30);
        ...
        for (NSInteger i = 0;i < nodeCount.count; i ++) {
            ...
            [cloudButton setTitle:[NSString stringWithFormat:@"%@",nodeCount[i]]
            ...
            NSLog(@"%ld.alpha==%f",i,cloudButton.alpha);
